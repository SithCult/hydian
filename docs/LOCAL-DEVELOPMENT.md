...
With nvm, `nvm install` selects the version in `.nvmrc`. Native builds also need
[Rust and Tauri's platform prerequisites](https://v2.tauri.app/start/prerequisites/): Xcode Command Line Tools
